...
{
  u32 flag = 0;
  u32 off = (sizeof(WiFiConfig)+3)&0xfffffffC;
  
  STMFLASH_Read(ADDR_FLASH_SECTOR_3+off, (u16*)&flag, 2);
  if (flag != 0xa5a5a5a5) {
    //默认不改变
  } else {
    STMFLASH_Read(ADDR_FLASH_SECTOR_3, (u16*)&WiFiConfig, (sizeof(WiFiConfig)+1)>>1);
  }
  return 0;
}
...
void config_save(void)
{
  ...
  STMFLASH_Write(ADDR_FLASH_SECTOR_3, (u16*)&WiFiConfig,  (sizeof(WiFiConfig)+1)>>1);
